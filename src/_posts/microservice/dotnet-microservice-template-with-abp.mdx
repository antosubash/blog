...
Once the solution is built then we have to update the connection string in the `appsettings.json` file. You can find the `appsettings.json` file in the `*.HttpApi.Host` projects and `DbMigrator` project. 
