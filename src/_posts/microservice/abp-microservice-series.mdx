...
I have created a template for creating a microservice application based on this series. You can find the template here: https://github.com/antosubash/AbpMicroservice
