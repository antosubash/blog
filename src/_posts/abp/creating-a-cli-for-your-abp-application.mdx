...
Somthimes when I am working on a project and I need to do some repetitive tasks, I create a cli for that. For example, Importing data from a csv file to the database. this is a repetitive task and I don't want to do it manually every time. But I don't want to create a UI for that. for these cases CLI can be very useful.
